...
describe('eventToFullCalendar()', function () {
	it('Constructive Test: ' +
		'Output format should match specs (no date, no cohort)', function() {
...
describe('eventToFullCalendar()', function () {
	it('Constructive Test: ' +
		'Output format should match specs (no date, with cohort)', function() {
...
describe('eventToFullCalendar()', function() {
	it('Constructive Test: ' +
		'Output format should match specs (with date, no cohort)', function() {
...
describe('eventToFullCalendar()', function() {
	it('Constructive Test: ' +
		'Output format should match specs (with date, with cohort)', function() {
